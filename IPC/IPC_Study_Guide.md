...
> **This book is split into one file per concept.**
> Each chapter lives in the [`chapters/`](chapters/) folder. The full index with reading
> paths is in **[README.md](README.md)**. Use the Table of Contents below to jump
